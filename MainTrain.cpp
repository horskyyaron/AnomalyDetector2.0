...
int main(){
    ...
    TimeSeries ts("/home/yaron/Desktop/AnomalyDetector/data.csv");
    vector<string> v = ts.getFeatures();
    ts.printFeatureData("yaron");
    ts.printFeatureData("jack");
    ts.getFeatureValAt("yaron",5);
    cout << ts.getFeatureValAt("yaron",1) << endl;
